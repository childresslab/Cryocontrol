...
SAVE_DIR = Path(r"X:\DiamondCloud\Cryostat setup\Data\2023-07-06-cooldown\trans_scan")
...
cavity_trans_scan.save_results(SAVE_DIR/'trans_scan_30x30.csv', as_npz=False, header=f"type: trans\ncenters: {centers}\nspans: {spans}\nsteps: {steps}")
cavity_trans_scan.save_results(SAVE_DIR/'trans_scan_30x30.npz', as_npz=True, header=f"type: trans\ncenters: {centers}\nspans: {spans}\nsteps: {steps}")
